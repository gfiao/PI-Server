...
/**
 * Created by Rafael on 02/06/2014.
 */
...
//    return {
//        bar: function() {
//            console.log("O GUI GOSTA DE UNS VALENTES PELES NO RABIOSQUE!!");
//        }
//    }
//
//
//});
(function() {
  ($('#bookmarkText')).append("<%= j render(partial: 'homepage/sync', locals: { c: @current_video_info }) %>");
