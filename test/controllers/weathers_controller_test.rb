...
class WeathersControllerTest < ActionController::TestCase
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post :create, weather: { city: @weather.city, date: @weather.date, max_temp: @weather.max_temp, min_temp: @weather.min_temp }
    end
  ...
  test "should update weather" do
    patch :update, id: @weather, weather: { city: @weather.city, date: @weather.date, max_temp: @weather.max_temp, min_temp: @weather.min_temp }
    assert_redirected_to weather_path(assigns(:weather))
  end
